...
const SecondDivide = () => {
    return (
        <div className={'flex gap-8 lg:justify-between lg:gap-0 lg:px-56 flex-wrap justify-center bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20 border-x-0 py-5 px-10'}>
